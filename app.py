...
if not st.session_state.df_inventario.empty:
    ...
    try:
        ...
        # ⚠️ NOTA CLAVE: La línea que BORRABA el historial fue removida para que la tabla conserve los registros de 'ventas_mes1.xlsx'.
...
# --- REGISTRO DE VENTAS ---
    ...
    if df_inventario.empty:
        ...
        st.info("Nota: Las ventas masivas se cargan automáticamente al inicio. El stock negativo está permitido.")
